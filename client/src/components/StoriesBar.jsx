            ...
            <div className='flex gap-4 pb-5'>
                ...
                bg-gradient-to-b from-indigo-50 to-white'>
                    ...
                    <div className='h-full flex flex-col items-center justify-center p-4'>
                        ...
                        <p className='text-sm font-medium text-center text-slate-700'>Create stories</p>
                    </div>
                </div>

                {/* Stories Cards */}
                {
                    stories[0] ? stories.map((story, index) => (
                        <div key={index + story._id} className={`relative rounded-lg shadow min-w-30 max-w-30 max-h-40
